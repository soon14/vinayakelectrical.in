...
class ControllerExtensionPaymentBhartiPay extends Controller
{
    ...
    public function index()
    {
        ...
        $return_url = $this->url->link('extension/payment/bhartipay/callback'. '&hash=' . md5($order_info['order_id'] . $order_info['total'] . $order_info['currency_code'] . $this->config->get('payment_bhartipay_salt')));
