...
/* this class is used to integrate merchant portal to Paynear Epay. */
   ...
   Class PaynearEpay {
        ...
        private $_secretkey;
        private $_testMode;
        private $_paynearEpayURLTest    = 'https://sandbox.payswiff.com/epay';
        private $_paynearEpayURLLive    = 'https://secure.paynear.in/epay';
        private $_paymentEndpoint       = '/payment/request';
		private $_verifyEndpoint        = '/payment/verify';
        private $_statusEndpoint        = '/payment/status';
		private $_refundEndpoint        = '/payment/refund';
        ...
        private function _httpRequest($endpoint, $params)
        {
			...
			$url='https://sandbox.payswiff.com/epay/payment/request';
