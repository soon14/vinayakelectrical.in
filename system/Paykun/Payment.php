...
class Payment {
    ...
    public function __construct(string $mid, string $accessToken, string $encKey, $isLive = true, $isCustomTemplate = false) {
    ...
    public function initOrder (string $orderId, string $purpose, string $amount, string $successUrl, string $failureUrl) {
    ...
    public function addCustomer(string $customerName, string $customerEmail, string $customerMoNo) {
    ...
    public function addShippingAddress(string $country, string $state, string $city, string $pinCode, string $addressString) {
    ...
    public function addBillingAddress(string $country, string $state, string $city, string $pinCode, string $addressString) {
    ...
    private function createForm(string $encData) {
