...
class ControllerExtensionPaymentPayzen extends Controller
{
    ...
    protected function getDefaultValues()
    {
        ...
        $data[$this->prefix . $this->name . '_ctx_mode'] = 'PRODUCTION';
        $data[$this->prefix . $this->name . '_sign_algo'] = 'SHA-1';
        $data[$this->prefix . $this->name . '_platform_url'] = 'https://secure.payzen.co.in/vads-payment/';
        $data[$this->prefix . $this->name . '_language'] = 'en';
        $data[$this->prefix . $this->name . '_redirect_enabled'] = '0';
        $data[$this->prefix . $this->name . '_redirect_success_timeout'] = '5';
        $data[$this->prefix . $this->name . '_redirect_success_message'] = 'Redirecting to the shop, please wait...';
        $data[$this->prefix . $this->name . '_redirect_error_timeout'] = '5';
        $data[$this->prefix . $this->name . '_redirect_error_message'] = 'Redirecting to the shop, please wait...';
