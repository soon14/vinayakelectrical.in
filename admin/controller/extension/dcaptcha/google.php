...
class ControllerExtensionDcaptchaGoogle extends Controller
{

    public function index($error = array())
    {
        $this->load->language('extension/dcaptcha/google');
        ...
        return $this->load->view('extension/dcaptcha/google', $data);
    }
