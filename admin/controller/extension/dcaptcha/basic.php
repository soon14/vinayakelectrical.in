...
class ControllerExtensionDcaptchaBasic extends Controller
{

    public function index($error = array())
    {
        $this->load->language('extension/dcaptcha/basic');
        ...
        return $this->load->view('extension/dcaptcha/basic', $data);
    }
